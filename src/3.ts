...
class Wizard implements ICharacter, ISpellCaster {
    ...
    introduce(phrase: string): void {
        console.log(`${phrase} ${this.name}, and my level of mighty and power is ${this.level}`);
    }
    ...
    levelUp(): void {
        this.level++;
        console.log(`Level up! New level is ${this.level}, You are next...`);
    }
}

// тестування класу
const wizard = new Wizard("Merlin", 100499);

wizard.introduce("You stupid morrons, I am the mighty wizard");
wizard.castSpell();
wizard.levelUp();
